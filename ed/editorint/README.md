...
- [x] 1 ponto - Left no início da linha move o cursor para o final da linha anterior.
- [x] 1 ponto - Right no final da linha move o cursor para o início da linha seguinte.
...
- [x] 1 ponto - Delete no final da linha junta as linhas e move o cursor para a posição correta.
